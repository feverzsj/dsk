...
// #ifndef DSK_FU2_INCLUDED_FUNCTION2_HPP_
// #define DSK_FU2_INCLUDED_FUNCTION2_HPP_
...
// Defines:
// - DSK_FU2_HAS_DISABLED_EXCEPTIONS
#if defined(DSK_FU2_WITH_DISABLED_EXCEPTIONS) ||                                   \
    defined(DSK_FU2_MACRO_DISABLE_EXCEPTIONS)
#define DSK_FU2_HAS_DISABLED_EXCEPTIONS
#else // DSK_FU2_WITH_DISABLED_EXCEPTIONS
#if defined(_MSC_VER)
...
#endif
#endif
#endif // DSK_FU2_WITH_DISABLED_EXCEPTIONS
// - DSK_FU2_HAS_LIMITED_EMPTY_PROPAGATION
#if defined(DSK_FU2_WITH_LIMITED_EMPTY_PROPAGATION)
#define DSK_FU2_HAS_LIMITED_EMPTY_PROPAGATION
#endif // DSK_FU2_WITH_NO_EMPTY_PROPAGATION
// - DSK_FU2_HAS_NO_FUNCTIONAL_HEADER
#if !defined(DSK_FU2_WITH_NO_FUNCTIONAL_HEADER) &&                                 \
    !defined(DSK_FU2_NO_FUNCTIONAL_HEADER) &&                                      \
    (!defined(DSK_FU2_HAS_DISABLED_EXCEPTIONS) ||                                  \
     defined(DSK_FU2_HAS_LIMITED_EMPTY_PROPAGATION))
#include <functional>
#else
#define DSK_FU2_HAS_NO_FUNCTIONAL_HEADER
#endif
// - DSK_FU2_HAS_CXX17_NOEXCEPT_FUNCTION_TYPE
#if defined(DSK_FU2_WITH_CXX17_NOEXCEPT_FUNCTION_TYPE)
#define DSK_FU2_HAS_CXX17_NOEXCEPT_FUNCTION_TYPE
#else // DSK_FU2_WITH_CXX17_NOEXCEPT_FUNCTION_TYPE
#if defined(_MSC_VER)
...
#define DSK_FU2_HAS_CXX17_NOEXCEPT_FUNCTION_TYPE
#endif
#endif // DSK_FU2_WITH_CXX17_NOEXCEPT_FUNCTION_TYPE

// - DSK_FU2_HAS_NO_EMPTY_PROPAGATION
#if defined(DSK_FU2_WITH_NO_EMPTY_PROPAGATION)
#define DSK_FU2_HAS_NO_EMPTY_PROPAGATION
#endif // DSK_FU2_WITH_NO_EMPTY_PROPAGATION

#if !defined(DSK_FU2_HAS_DISABLED_EXCEPTIONS)
#include <exception>
#endif

#if defined(__cpp_constexpr) && (__cpp_constexpr >= 201304)
#define DSK_FU2_DETAIL_CXX14_CONSTEXPR constexpr
...
#define DSK_FU2_DETAIL_CXX14_CONSTEXPR constexpr
#endif
#ifndef DSK_FU2_DETAIL_CXX14_CONSTEXPR
#define DSK_FU2_DETAIL_CXX14_CONSTEXPR
#endif

/// Hint for the compiler that this point should be unreachable
#if defined(_MSC_VER)
// NOLINTNEXTLINE(cppcoreguidelines-macro-usage)
#define DSK_FU2_DETAIL_UNREACHABLE_INTRINSIC() __assume(false)
#elif defined(__GNUC__)
// NOLINTNEXTLINE(cppcoreguidelines-macro-usage)
#define DSK_FU2_DETAIL_UNREACHABLE_INTRINSIC() __builtin_unreachable()
...
#endif
#endif
#ifndef DSK_FU2_DETAIL_UNREACHABLE_INTRINSIC
// NOLINTNEXTLINE(cppcoreguidelines-macro-usage)
#define DSK_FU2_DETAIL_UNREACHABLE_INTRINSIC() abort()
#endif

/// Causes the application to exit abnormally
#if defined(_MSC_VER)
// NOLINTNEXTLINE(cppcoreguidelines-macro-usage)
#define DSK_FU2_DETAIL_TRAP() __debugbreak()
#elif defined(__GNUC__)
// NOLINTNEXTLINE(cppcoreguidelines-macro-usage)
#define DSK_FU2_DETAIL_TRAP() __builtin_trap()
#elif defined(__has_builtin)
...
#endif
#endif
#ifndef DSK_FU2_DETAIL_TRAP
// NOLINTNEXTLINE(cppcoreguidelines-macro-usage)
#define DSK_FU2_DETAIL_TRAP() *(volatile int*)0x11 = 0
#endif

#ifndef NDEBUG
// NOLINTNEXTLINE(cppcoreguidelines-macro-usage)
#define DSK_FU2_DETAIL_UNREACHABLE() ::dsk::fu2::detail::unreachable_debug()
#else
// NOLINTNEXTLINE(cppcoreguidelines-macro-usage)
#define DSK_FU2_DETAIL_UNREACHABLE() DSK_FU2_DETAIL_UNREACHABLE_INTRINSIC()
#endif
...
template <bool Owning, bool Copyable, typename Capacity, typename Allocator = std::allocator<void>>
struct config {
  ...
  using allocator = Allocator; // default allocator
};
...
struct is_noexcept_correct<true, T, identity<Args...>>
    : std::integral_constant<bool,
                             noexcept(::dsk::fu2::detail::invocation::invoke(
...
static DSK_FU2_DETAIL_CXX14_CONSTEXPR void write_empty(data_accessor* accessor,
                                                   bool empty) noexcept {
...
DSK_FU2_DETAIL_CXX14_CONSTEXPR auto retrieve(std::true_type /*is_inplace*/,
                                         Accessor from,
...
#if !defined(DSK_FU2_HAS_DISABLED_EXCEPTIONS)
#if defined(DSK_FU2_HAS_NO_FUNCTIONAL_HEADER)
...
#ifdef DSK_FU2_HAS_CXX17_NOEXCEPT_FUNCTION_TYPE
#define DSK_FU2_DETAIL_EXPAND_QUALIFIERS_NOEXCEPT(F)                               \
  F(, , noexcept, , &)                                                         \
  F(const, , noexcept, , &)                                                    \
  F(, volatile, noexcept, , &)                                                 \
  ...
  F(, volatile, noexcept, &&, &&)                                              \
  F(const, volatile, noexcept, &&, &&)
#define DSK_FU2_DETAIL_EXPAND_CV_NOEXCEPT(F)                                       \
  F(, , noexcept)                                                              \
  F(const, , noexcept)                                                         \
  F(, volatile, noexcept)                                                      \
  F(const, volatile, noexcept)
#else // DSK_FU2_HAS_CXX17_NOEXCEPT_FUNCTION_TYPE
#define DSK_FU2_DETAIL_EXPAND_QUALIFIERS_NOEXCEPT(F)
#define DSK_FU2_DETAIL_EXPAND_CV_NOEXCEPT(F)
#endif // DSK_FU2_HAS_CXX17_NOEXCEPT_FUNCTION_TYPE

#define DSK_FU2_DETAIL_EXPAND_QUALIFIERS(F)                                        \
  F(, , , , &)                                                                 \
  F(const, , , , &)                                                            \
  F(, volatile, , , &)                                                         \
  F(const, volatile, , , &)                                                    \
  ...
  F(, volatile, , &&, &&)                                                      \
  F(const, volatile, , &&, &&)                                                 \
  DSK_FU2_DETAIL_EXPAND_QUALIFIERS_NOEXCEPT(F)
#define DSK_FU2_DETAIL_EXPAND_CV(F)                                                \
  F(, , )                                                                      \
  F(const, , )                                                                 \
  F(, volatile, )                                                              \
  F(const, volatile, )                                                         \
  DSK_FU2_DETAIL_EXPAND_CV_NOEXCEPT(F)
...
#ifdef DSK_FU2_HAS_DISABLED_EXCEPTIONS
...
#define DSK_FU2_DEFINE_FUNCTION_TRAIT(CONST, VOLATILE, NOEXCEPT, OVL_REF, REF)     \
...
DSK_FU2_DETAIL_EXPAND_QUALIFIERS(DSK_FU2_DEFINE_FUNCTION_TRAIT)
#undef DSK_FU2_DEFINE_FUNCTION_TRAIT
...
public:
  ...
  DSK_FU2_DETAIL_CXX14_CONSTEXPR data_accessor* opaque_ptr() noexcept {
    return &storage_.accessor_;
  }
  constexpr data_accessor const* opaque_ptr() const noexcept {
    return &storage_.accessor_;
  }
  DSK_FU2_DETAIL_CXX14_CONSTEXPR data_accessor volatile*
...
public:
  ...
  DSK_FU2_DETAIL_CXX14_CONSTEXPR erasure() noexcept {
    vtable_.set_empty();
  }

  DSK_FU2_DETAIL_CXX14_CONSTEXPR erasure(std::nullptr_t) noexcept {
    vtable_.set_empty();
  }

  DSK_FU2_DETAIL_CXX14_CONSTEXPR
  ...
  DSK_FU2_DETAIL_CXX14_CONSTEXPR erasure(erasure const& right) {
  ...
  template <typename T, typename Allocator = Config::allocator> //std::allocator<std::decay_t<T>>>
  DSK_FU2_DETAIL_CXX14_CONSTEXPR erasure(std::false_type /*use_bool_op*/,
                                     T&& callable,
  ...
  template <typename T, typename Allocator = Config::allocator> //std::allocator<std::decay_t<T>>>
  DSK_FU2_DETAIL_CXX14_CONSTEXPR erasure(std::true_type /*use_bool_op*/,
                                     T&& callable,
                                     Allocator&& allocator_ = Allocator{}) {
    if (!!callable) {
      vtable_t::init(vtable_,
  ...
  DSK_FU2_DETAIL_CXX14_CONSTEXPR erasure& operator=(erasure const& right) {
    vtable_.weak_destroy(this->opaque_ptr(), capacity());
    right.vtable_.copy(vtable_, right.opaque_ptr(), right.capacity(),
                       this->opaque_ptr(), capacity());
    return *this;
...
public:
  ...
  template <typename T>
  // NOLINTNEXTLINE(cppcoreguidlines-pro-type-member-init)
  DSK_FU2_DETAIL_CXX14_CONSTEXPR erasure(std::true_type use_bool_op, T&& object) {
...
#if defined(DSK_FU2_HAS_NO_EMPTY_PROPAGATION)
template <typename T>
struct use_bool_op : std::false_type {};
#elif defined(DSK_FU2_HAS_LIMITED_EMPTY_PROPAGATION)
...
#define DSK_FU2_DEFINE_USE_OP_TRAIT(CONST, VOLATILE, NOEXCEPT)                     \
  template <typename Ret, typename... Args>                                    \
  struct use_bool_op<Ret (*CONST VOLATILE)(Args...) NOEXCEPT>                  \
      : std::true_type {};

DSK_FU2_DETAIL_EXPAND_CV(DSK_FU2_DEFINE_USE_OP_TRAIT)
#undef DSK_FU2_DEFINE_USE_OP_TRAIT

template <typename Ret, typename... Args>
struct use_bool_op<Ret(Args...)> : std::false_type {};

#if defined(DSK_FU2_HAS_CXX17_NOEXCEPT_FUNCTION_TYPE)
template <typename Ret, typename... Args>
struct use_bool_op<Ret(Args...) noexcept> : std::false_type {};
#endif
#endif // DSK_FU2_HAS_NO_EMPTY_PROPAGATION
...
public:
  ...
  explicit DSK_FU2_DETAIL_CXX14_CONSTEXPR
  function(function const& /*right*/) = default;
  explicit DSK_FU2_DETAIL_CXX14_CONSTEXPR function(function&& /*right*/) = default;
  ...
  template <typename RightConfig,
            enable_if_copyable_correct_t<Config, RightConfig>* = nullptr,
            enable_if_owning_correct_t<Config, RightConfig>* = nullptr>
  DSK_FU2_DETAIL_CXX14_CONSTEXPR function(function<RightConfig, property_t>&& right)
  ...
  DSK_FU2_DETAIL_CXX14_CONSTEXPR function(T&& callable)
  ...
  template <typename T, typename Allocator, //
            ...
            assert_wrong_copy_assign_t<T>* = nullptr,
            assert_no_strong_except_guarantee_t<T>* = nullptr>
  DSK_FU2_DETAIL_CXX14_CONSTEXPR function(T&& callable, Allocator&& allocator_)
      : erasure_(use_bool_op<unrefcv_t<T>>{}, std::forward<T>(callable),
                 std::forward<Allocator>(allocator_)) {
  }

  /// Empty constructs the function
  DSK_FU2_DETAIL_CXX14_CONSTEXPR function(std::nullptr_t np) : erasure_(np) {
  }
...
/// through defining `DSK_FU2_WITH_NO_FUNCTIONAL_HEADER`.
///
...
struct uses_allocator<
    ::dsk::fu2::detail::function<Config, Property>,
    Alloc
> : std::true_type {};
} // namespace std


#undef DSK_FU2_DETAIL_EXPAND_QUALIFIERS
#undef DSK_FU2_DETAIL_EXPAND_QUALIFIERS_NOEXCEPT
#undef DSK_FU2_DETAIL_EXPAND_CV
#undef DSK_FU2_DETAIL_EXPAND_CV_NOEXCEPT
#undef DSK_FU2_DETAIL_UNREACHABLE_INTRINSIC
#undef DSK_FU2_DETAIL_TRAP
#undef DSK_FU2_DETAIL_CXX14_CONSTEXPR

// #endif // DSK_FU2_INCLUDED_FUNCTION2_HPP_
...
template<bool IsOwning, bool IsCopyable, size_t Cap, size_t Align, class Alloc,
         bool IsThrowing, bool HasStrongExceptGuarantee, typename... Signatures>
using function_base = fu2::detail::function<
                        fu2::detail::config<IsOwning, IsCopyable, fu2::capacity_fixed<Cap, Align>, Alloc>,
                        fu2::detail::property<IsThrowing, HasStrongExceptGuarantee, Signatures...>>;


// A copyable function wrapper for arbitrary callable types.
template<
    class Signature,
    class  Alloc = DSK_DEFAULT_ALLOCATOR<void>,
    size_t   Cap = fu2::capacity_default::capacity,
    size_t Align = fu2::capacity_default::alignment
>
using function = function_base<true, true, Cap, Align, Alloc,
                               true, false, Signature>;

// A move only function wrapper for arbitrary callable types.
template<
    class Signature,
    class  Alloc = DSK_DEFAULT_ALLOCATOR<void>,
    size_t   Cap = fu2::capacity_default::capacity,
    size_t Align = fu2::capacity_default::alignment
>
using unique_function = function_base<true, false, Cap, Align, Alloc,
                                      true, false, Signature>;

// A non owning copyable function wrapper for arbitrary callable types.
template<class... Signatures>
using function_view = function_base<false, true, 0, 0, void,
                                    true, false, Signatures...>;


// small object buffer of Cap and Align, overlapped with one pointer to allocated callable.
// one pointer to life cycle management function.
// one pointer to invoke function or tuple of invoke functions to invoke as Signatures.
static_assert(sizeof(unique_function<void()>) == 2*sizeof(void*) + 2*sizeof(void*));
static_assert(alignof(unique_function<void()>) == alignof(std::max_align_t));

static_assert(std::uses_allocator_v<fu2::function<void()>, std::allocator<void>>);
static_assert(
    std::is_same_v<
    decltype(std::uses_allocator_construction_args<
        fu2::function<void(void*)>>(
            std::allocator<void>(), std::default_delete<void>())),
    std::tuple<std::default_delete<void>&&, std::allocator<void> const&>>);
