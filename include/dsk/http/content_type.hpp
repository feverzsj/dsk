...
struct http_content_type
{
    ...
    void parse(_http_fields_ auto const& flds)
    {
...
auto parse_http_content_type(_http_fields_ auto const& flds)
{
    http_content_type t;
    t.parse(flds);
    return t;
