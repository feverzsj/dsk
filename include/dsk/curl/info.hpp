...
inline constexpr auto capath                  = info_c<CURLINFO_CAPATH                   , char const*         >;
inline constexpr auto cainfo                  = info_c<CURLINFO_CAINFO                   , char const*         >;
...
inline constexpr auto conn_id                 = info_c<CURLINFO_CONN_ID                  , curl_off_t          >;
inline constexpr auto xfer_id                 = info_c<CURLINFO_XFER_ID                  , curl_off_t          >;
...
inline constexpr auto queue_time              = info_c<CURLINFO_QUEUE_TIME_T             , curl_off_t          >;
